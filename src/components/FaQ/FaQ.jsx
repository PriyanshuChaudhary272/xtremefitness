            ...
            <div>
                <div className="max-min mx-auto career faq-main-div">
                    <div className='d-flex flex-column align-items-center'>
                        <h1 className='faq-main-heading text-center m-0'>POPULAR FAQs FOR INFLUENCERS</h1>
                        <h3 className='faq-sub-heading text-center mx-4 mx-lg-0'>Hello Visitor! These are the most asked questions from inflluencers.</h3>
                        <form className='faq-search-div'>
                            <input type="text" className='d-inline faq-search p-3 p-md-4' placeholder='Type your question here' />
